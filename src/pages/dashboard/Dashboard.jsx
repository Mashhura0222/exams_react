...
const Dashboard = () => {
  return (
    <div>
       ...
       <header style={{ height:"50px", display:"flex" ,alignContent:"center",justifyContent:"space-between",borderRadius:"10px" ,boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)",padding:"0px 20px",margin:" 20px   80px"}}>
